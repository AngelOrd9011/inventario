...
if (isset($_POST['infoEmpleado'])) {
  for($i=0;$i<count($reg);$i++){
    ...
    <div class='modal-footer grey lighten-2 flexbox'>
      <a id='".$reg[$i]['id_empleado']."' class='modal-close waves-effect waves-green btn-flat green darken-2 white-text pdfFunction'>Descargar<i class='material-icons right'>picture_as_pdf</i></a>
